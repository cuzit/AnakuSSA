...
/** HelloAudio
 *  @author cuzit
 *  Description: Learning how to do audio this time baby
...
public class HelloAudio  extends SimpleApplication {
     ...
     private void initAudio() {
          /* gun shot sound is to be triggered by a mosue click */
          ...
          audio_nature.setLooping(true); // activates continous playing
          audio_nature.setVolume(3);
          rootNode.attachChild(audio_nature);
          audio_nature.play(); //play continously!
     }
     ...
     private ActionListener actionListener = new ActionListener() {
          ...
          public void onAction(String name, boolean keyPressed, float tpf) {
               if(name.equals("Shoot") && !keyPressed) {
                    audio_gun.playInstance(); // play each instance ONCE! ONCE YOU FUCKER ONCE!
               }
          }
     };
