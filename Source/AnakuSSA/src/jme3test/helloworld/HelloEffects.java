...
/** HelloEffects
 *  @author cuzit
 *  Description: JME3 Tutorial on particle effects
...
public class HelloEffects extends SimpleApplication {
     ...
     public void simpleInitApp() {
          ...
          water.setEndColor(new ColorRGBA(0, 1f, 1f, 1f)); //Cyan
          water.setStartColor(new ColorRGBA(0, 0, 1f, 1f)); //Blue
          water.getParticleInfluencer().setInitialVelocity(new Vector3f(0, -2, 0));
          water.setStartSize(0.1f);
          water.setEndSize(1.5f);
          water.setGravity(0, 1, 0);
          water.setLowLife(1f);
          water.setHighLife(3f);
          water.getParticleInfluencer().setVelocityVariation(0.3f);
          water.setLocalTranslation(3f, 0, 0);
